...
find_path(fmt_INCLUDE_DIR
  NAMES fmt/format.h
  PATHS "$ENV{FMT_ROOT}/include" "$ENV{FMT_ROOT}" NO_DEFAULT_PATH)
...
find_library(fmt_LIBRARY
  NAMES fmt
  HINTS "$ENV{FMT_ROOT}/lib" "$ENV{FMT_ROOT}" NO_DEFAULT_PATH
  DOC "fmt libraries"
)
...
message( "${Esc}[33m" "fmt_INCLUDE_DIR" "          : " "${fmt_INCLUDE_DIR}" "${Esc}[0m" )
message( "${Esc}[33m" "fmt_LIBRARY" "              : " "${fmt_LIBRARY}" "${Esc}[0m" )
